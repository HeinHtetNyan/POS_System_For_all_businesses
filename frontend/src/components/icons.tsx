...
export const IconGlobe      = (p: IconProps) => <svg {...IC} {...p}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
export const IconSmartphone = (p: IconProps) => <svg {...IC} {...p}><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="11" y1="18" x2="13" y2="18"/></svg>
export const IconMonitor    = (p: IconProps) => <svg {...IC} {...p}><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
export const IconYoutube    = (p: IconProps) => <svg {...IC} {...p}><rect x="2" y="5" width="20" height="14" rx="4"/><polygon points="10 9 16 12 10 15 10 9" fill="currentColor" stroke="none"/></svg>
export const IconPhoneCall  = (p: IconProps) => <svg {...IC} {...p}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
export const IconTelegram   = (p: IconProps) => <svg {...IC} {...p}><path d="M22 2 2 10.5l7 2.5M22 2 13.5 21l-4.5-8M22 2 9.5 13"/></svg>
export const IconViber      = (p: IconProps) => <svg {...IC} {...p}><path d="M12 3C7 3 3.5 6 3.5 10.2c0 2.5 1.4 4.7 3.6 6.1l-.6 3.4 3.4-1.7c.7.15 1.4.2 2.1.2 5 0 8.5-3 8.5-7.2S17 3 12 3z"/><path d="M8.5 9.5c0 3.5 2 5.5 5.5 5.5" strokeLinecap="round"/><path d="M12 8.2c1.3 0 2.3 1 2.3 2.3" strokeLinecap="round"/></svg>
export const IconLink       = (p: IconProps) => <svg {...IC} {...p}><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
export const IconMail       = (p: IconProps) => <svg {...IC} {...p}><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 6-10 7L2 6"/></svg>
export const IconFacebook   = (p: IconProps) => <svg {...IC} {...p}><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
export const IconTiktok     = (p: IconProps) => <svg {...IC} {...p}><path d="M16 2v3.5a5 5 0 0 0 4 4.9V14a8.5 8.5 0 0 1-5-1.6V16a6 6 0 1 1-6-6c.34 0 .67.03 1 .08V13a2.5 2.5 0 1 0 2 2.45V2z"/></svg>
